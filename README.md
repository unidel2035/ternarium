...
**Мозг мухи в кремнии** (`fly_core/`): троичный CSR-матvec срезa коннектома дрозофилы — BRAM-движок без умножителей, 1.5 такта/трит, верифицирован против numpy-эталона.
...
- [x] Memory-image: весь мозг в 2 бита = **1.48 МБ**; срез топ-4096 нейронов (211 606 тритов, 423 КБ BRAM) → `fly_core/sim/`
- [x] RTL-движок `fly_core` (CSR, 1.5 такта/трит): проход среза за **6.6 мс @50МГц**, PASS против CPU-эталона (iverilog)
- [ ] Прошивка на Tang Mega 138K + выдача y по UART
